  ...
  return (
    <div>
      ...
      <section className="py-16">
        <div className="container">
          <div className="mx-auto max-w-3xl">
            <h2 className="mb-6 text-3xl font-bold text-blue-600">Vakfın Hikayesi</h2>
        ...
        <div className="container">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="flex flex-col items-center gap-8 rounded-xl bg-white p-8 shadow-sm md:flex-row md:items-start">
              ...
              <div>
                <h3 className="mb-2 text-2xl font-bold text-blue-600">M. Abdullah Yılmaz</h3>
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-xl bg-blue-50 p-6">
                <h3 className="mb-4 text-xl font-bold text-blue-600">Erişilebilirlik</h3>
              ...
              <div className="rounded-xl bg-blue-50 p-6">
                <h3 className="mb-4 text-xl font-bold text-blue-600">Dayanışma</h3>
                <p className="text-gray-600">
              ...
              <div className="rounded-xl bg-blue-50 p-6">
                <h3 className="mb-4 text-xl font-bold text-blue-600">Profesyonellik</h3>
                <p className="text-gray-600">
              ...
              <div className="rounded-xl bg-blue-50 p-6">
                <h3 className="mb-4 text-xl font-bold text-blue-600">Kapsayıcılık</h3>
                <p className="text-gray-600">
            ...
            <div className="mt-12 rounded-xl bg-[#eff6ff] p-8 text-gray-800">
              <h3 className="mb-4 text-2xl font-bold">Uzun Vadeli Vizyonumuz: Psikoloji Enstitüsü</h3>
              <p className="mb-6">
      ...
      <section className="bg-gray-50 py-16">
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-6 text-3xl font-bold text-blue-600">Bize Katılın</h2>
