    ...
    >
      ...
      <div className="container relative z-10 py-12 px-8 md:px-12 mx-auto max-w-7xl text-gray-800">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4 items-start">
            ...
            <div className="flex space-x-4">
              {[
                ...
                },
                {
                  icon: Youtube,
                  href:
                    "https://www.youtube.com/@YolArkada%C5%9Flar%C4%B1Dan%C4%B1%C5%9Fmanl%C4%B1k",
                  label: "Youtube",
                },
                {
                  icon: Linkedin,
                  href:
                    "https://www.linkedin.com/company/yol-arkada%C5%9Flar%C4%B1-psikolojik-dan%C4%B1%C5%9Fmanl%C4%B1k",
                  label: "LinkedIn",
                },
              ].map((social, index) => (
                <Link
          ...
          <div>
            <h3
              className="mb-6 text-xl font-bold font-lora italic"
              style={{ color: "#000000" }}
            >
              Hızlı Bağlantılar
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-800/80 font-aristoteles">
                  +90 539 889 33 75
                </span>
              </li>
              <li className="flex items-center">
        ...
        <div className="mt-16 pt-8 border-t border-gray-200/50 text-center">
          <p className="text-gray-800/70 text-sm font-aristoteles">
            © {new Date().getFullYear()} Yol Arkadaşları Psikoloji Vakfı. Tüm
            hakları saklıdır.
          </p>
        </div>
      </div>
