      ...
      <div className="container relative z-10 py-12 px-6 md:px-12 mx-auto max-w-7xl text-gray-800">
        <div className="grid gap-12 lg:grid-cols-5 items-start">
          ...
          <div>
            ...
            <div className="space-y-3" aria-label="Çalışma saatleri">
              <div className="bg-white/20 rounded-lg p-4 backdrop-blur-sm">
                <div className="flex flex-col space-y-2 text-sm text-gray-800/80 font-aristoteles">
                  <div className="flex justify-between items-center">
                    <span className="font-medium">Pazartesi - Cumartesi</span>
                    <span className="text-gray-800 font-semibold">09:00 - 20:00</span>
                  </div>
                  <div className="border-t border-gray-200/30 pt-2 flex justify-between items-center">
                    <span className="font-medium">Pazar</span>
                    <span className="text-gray-800 font-semibold">Kapalı</span>
                  </div>
                </div>
              </div>
              
              {/* Additional info */}
              <div className="text-xs text-gray-600 font-aristoteles mt-3">
                <p>Acil durumlar için online randevu sistemimizi kullanabilirsiniz.</p>
              </div>
            </div>
          </div>
        </div>
